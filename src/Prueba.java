	...
	public VentanaInicio() {
		...
		setVisible(true);
		 ...
		 panel1.setBounds(20, 20, 300, 400);
			...
			panel1.setPreferredSize(new Dimension(this.getWidth()/2 - 20, this.getHeight()/3-30));
			add(panel1);
			...
			
			{
				...
				panel3.setPreferredSize(new Dimension(this.getWidth()/2 + 60, this.getHeight()/3 - 20));
				panel2.add(panel3);
			}
			...
			area1.setText("Texto largototote que deveria ir aqui");
			area1.setLineWrap(true);
			area1.setWrapStyleWord(true);
			panel2.add(area1);
			
			panel2.setPreferredSize(new Dimension(this.getWidth()/1 - 40, this.getHeight()));
			add(panel2);
		}//constructor
}//class 
public class prueba {
